...
class ExperimentGratings(object):
    ...
    def run(self):
        ...
        myInstruction=InstructionsDipoles(self.win, 6)
    ...
    def create_window(self):
        ...
        # for contrast 50, luminance 50
        if (self.lumsGr==self.lumsD and self.lumsD =='50'):
        ...
        if (self.lumsGr==self.lumsD and self.lumsD =='15'):
