...
class Dipoles_presentation(object):
    ...
    #def rotate_square(square, angle, center_point=(0, 0)):
    ...
    #        rotated_square.append(rotated_corner)
    ...
    def run(self):
        ...
        gr_1 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (-4, -4), size = 4*0.1, sf = 0.1, contrast = 0) #*(1/2.0612))
        gr_1_2 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (-3, -3), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_2 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (4, 4), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_2_2 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (3, 3), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_3 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (-4, 4), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_3_2 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (-3, 3), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_4 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (4, -4), size = 4*0.1, sf = 0.1, contrast = 0)
        gr_4_2 = visual.GratingStim(self.win, tex = "sin",mask = "gauss", units = "deg", pos = (3, -3), size = 4*0.1, sf = 0.1, contrast = 0)		
        ...
        while len(cond)>1:
            ...
            dir = self.trial(self.win, gr_1,gr_1_2,gr_2,gr_2_2,gr_3,gr_3_2, gr_4, gr_4_2, tfreq, sfreq, nextValue[nextIndex] )
            key=response.run()
            if (key=='left'):
    ...
    def trial(self, win, gr_1,gr_1_2, gr_2,gr_2_2, gr_3,gr_3_2,gr_4,gr_4_2, tfreq, sfreq, nextValue):
        ...
        trialComponents.append(gr_1)
        trialComponents.append(gr_1_2)
        trialComponents.append(gr_2)
        trialComponents.append(gr_2_2)		
        trialComponents.append(gr_3)
        trialComponents.append(gr_3_2)
        trialComponents.append(gr_4)
        trialComponents.append(gr_4_2)		
        ...
        while continueRoutine:
           # print frameN
            ...
            if frameN>=30:
                gr_1.setAutoDraw(True)
                gr_1_2.setAutoDraw(True)
                gr_2.setAutoDraw(True)
                gr_2_2.setAutoDraw(True)
                gr_3.setAutoDraw(True)
                gr_3_2.setAutoDraw(True)
                gr_4.setAutoDraw(True)
                gr_4_2.setAutoDraw(True)				
                gr_1.phase =  t*tfreq*direction # drift at 7 Hz
                gr_1_2.phase =  t*tfreq*direction
                gr_2.phase =  t*tfreq*direction
                gr_2_2.phase =  t*tfreq*direction
                gr_3.phase =  t*tfreq*direction
                gr_3_2.phase =  t*tfreq*direction
                gr_4.phase =  t*tfreq*direction
                gr_4_2.phase =  t*tfreq*direction				
                if frameN>(30+18) or event.getKeys(['e']):
                    gr_1.setAutoDraw(False)
                    gr_1_2.setAutoDraw(False)
                    gr_2.setAutoDraw(False)
                    gr_2_2.setAutoDraw(False)
                    gr_3.setAutoDraw(False)
                    gr_3_2.setAutoDraw(False)
                    gr_4.setAutoDraw(False)
                    gr_4_2.setAutoDraw(False)					
...
class ExperimentDipoles(object):
    ...
    def run(self):
        ...
        myInstruction=Instructions(self.win, 1)
...
#        ExpLattices.run()
        instruction_feedback=Instructions(self.win, )
        self.win.close()
    ...
    def create_window(self):
        ...
        print (currentCal)
        mon.saveMon()
        win = visual.Window(size=(1920, 1200), useFBO=True, fullscr=True, screen=0, allowGUI=False, allowStencil=True,
...
#my_square = [(-4, -4), (-4, 4), (4, 4), (4,-4)]
#rotate_square.run(my_square, 90)
